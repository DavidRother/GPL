...
folder_path = "evalpy"
experiment_identifier = "lbf_population_training"
...
env = env_creator.get_env_instance(identifier, players=n_agents, tasks=tasks)
eval_env = env_creator.get_env_instance(testing_identifier, players=n_agents, tasks=tasks)
...
super_agent = meta_agent.MetaAgent([no_op_agent, random_agent])
