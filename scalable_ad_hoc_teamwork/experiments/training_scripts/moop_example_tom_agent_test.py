...
from scalable_ad_hoc_teamwork.algorithm.ppo_tom_architecture.agent import Architecture
import numpy as np
import torch
import tqdm
import pickle
...
folder_path = "evalpy"
experiment_identifier = "lbf_test_tom_agent_H5"
experiment_name = f"tom_moop_experiment_{experiment_identifier}_{seed}"
...
interaction_architecture = Architecture.SEPARATED
learning_rate = 5e-5
gamma = 0.95
...
if checkpoint:
    ...
    moop_agent = agent_creator.get_agent_instance("tom_moop", obs_dim_state=obs_dim_state, obs_dim_agent=obs_dim_agent,
