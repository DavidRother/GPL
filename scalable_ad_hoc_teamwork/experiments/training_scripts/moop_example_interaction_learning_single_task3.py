...
obs_spaces = [ObservationSpace.VECTOR_OBSERVATION, ObservationSpace.VECTOR_OBSERVATION]
tasks = ["", "collect_apples"]

n_agents = 2

env = env_creator.get_env_instance(identifier, players=n_agents, obs_spaces=obs_spaces, tasks=tasks)
eval_env = env_creator.get_env_instance(testing_identifier, players=n_agents, obs_spaces=obs_spaces, tasks=tasks)
