...
class InteractionPPONetwork(nn.Module):
    ...
    def forward(self, obs_state, obs_agent, obs_other_agent, hidden_state=None):
        ...
        if hidden_state is not None:
            ...
            agent_type_output, self._hidden_state = self._hidden_type_layers(concat_input, self._old_hidden_state)
            ...
            self._agent_type_output, self._hidden_state = self._hidden_type_layers(concat_input, self._old_hidden_state)
