...
class TaskPPONetwork(nn.Module):

    def __init__(self, in_dim_state, out_dim, lr=0.0001, device="cpu"):
        super(TaskPPONetwork, self).__init__()
    ...
    def forward(self, obs_state):
        self._output = self._hidden_layers(obs_state)
